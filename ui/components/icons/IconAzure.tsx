...
export function IconAzure({ size = 24, className = "", ...props }) {
  return (
    <svg
    ...
    >
      ...
      />
      <path
        fill="url(#azure-gradient-opacity)"
