...
export default function IconLlama({
  size = 24,
  className = "",
  color = "#000000",
  ...props
  ...
  return (
    ...
    >
      ...
      >
        ...
        c99 183 64 439 -81 591 l-58 61 3 142 c4 164 -13 266 -58 357 -64 126 -172 159
        -263 79 -54 -47 -92 -138 -123 -298 -3 -14 -10 -22 -17 -18 -182 80 -297 85
        -443 21 l-54 -24 -4 22 c-36 185 -85 285 -156 322 -43 21 -74 24 -113 10z
